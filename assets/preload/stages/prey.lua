...
setProperty('furnace_gotcha.visible', false);
 ...
 setLuaSpriteScrollFactor('stardustFloor', 1, 1);
  setGraphicSize('stardustFloor', getProperty('stardustFloor.width') * 2);
 ...
 setLuaSpriteScrollFactor('stardustFloor2', 1, 1);
  setGraphicSize('stardustFloor2', getProperty('stardustFloor2.width') * 2);
